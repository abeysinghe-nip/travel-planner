    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        if($_SERVER["REQUEST_METHOD"]==="POST"){
           ...
           /* try {
                ...
                $query = "UPDATE admin SET Admin_Id=?, Admin_Name=?,Email_Address=?,Address=?,Password=?, WHERE id=?";
                $pstmt = $con->prepare($query);
                $pstmt->bindValue(1, $adminId);
                $pstmt->bindValue(2, $adminname);
                $pstmt->bindValue(3, $adminemail);
                $pstmt->bindValue(4,  $adminaddress);
                $pstmt->bindValue(5,  $adminpassword);
                $pstmt->bindValue(6, $id);
                $pstmt->execute();
                if($pstmt->rowCount() > 0){
        ...
        <form action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="POST">
            ...
            <table>
                ...
                <tr>
                 ...
                 <tr>
                    <td>Address</td>
                    <td><input type="text" name="adminaddress" ></td>
